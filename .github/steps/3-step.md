...
1. Enter the following comment and click the **Submit review** button.
   ...
   <img width="300" alt="Submit review button" src="https://github.com/avinashkr141/skills-review-pull-requests-2/blob/main/.github/images/submit-review-button.png?raw=true" />
